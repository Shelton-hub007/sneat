        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- /Logo -->
              <h4 class="mb-2">Bem vindo a Sneat! 👋</h4>
              <p class="mb-4">Por favor.  faça login em sua conta e comece a aventura</p>

              <form id="formAuthentication" class="mb-3" action="./dashboard.php" method="POST">
                <div class="mb-3">
                  <label for="email" class="form-label">Email ou Name de usuário</label>
                  <input
                    type="text"
                    class="form-control"
                    id="email"
